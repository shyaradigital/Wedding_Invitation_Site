              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                >
                  <p className="text-base sm:text-lg md:text-xl font-serif text-gray-700 leading-relaxed text-center">
                    DoubleTree by Hilton Hotel Irvine – Spectrum provides complimentary shuttle from John Wayne Airport. Guests are requested to call <span className="font-semibold">949-471-8888</span> upon arrival. Guests arriving at LAX can use Uber or Lyft.
                  </p>
                </motion.div>
