...
export default function PreviewAboutJayContent({ token }: { token: string }) {
  return (
    <>
      <PreviewBanner />
      <PageTransition>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
            ...
            >
              ...
              <div className="mb-10 sm:mb-12">
                <div className="relative w-full h-64 sm:h-80 md:h-96 bg-gradient-to-br from-wedding-gold-light via-wedding-cream to-wedding-rose-pastel rounded-xl overflow-hidden">
              ...
              <div className="prose prose-lg max-w-none space-y-8 sm:space-y-10">
                ...
                >
                  ...
                  <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed">
                    [Placeholder: Personal story, background, interests, achievements, and what makes Jay special. This section can be customized with his story, hobbies, career, and personality.]
                  </p>
                </motion.section>
                ...
                >
                  ...
                  <div className="space-y-3">
                    <p className="text-lg sm:text-xl font-semibold text-wedding-navy">
                      Mr. Bhavan Vidyut Mehta
                    </p>
                    <p className="text-lg sm:text-xl font-semibold text-wedding-navy">
                      Mrs. Nina Bhavan Mehta
                    </p>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700 text-base sm:text-lg">Late Mr. Vidyut Mehta</p>
                      <p className="text-gray-700 text-base sm:text-lg">Late Mrs. Uma Mehta</p>
                    </div>
                    <div>
                      <p className="text-base sm:text-lg font-semibold text-wedding-navy mb-2">Maternal Grandparents:</p>
                      <p className="text-gray-700 text-base sm:text-lg">Late Mr. Tansukh Shukla</p>
                      <p className="text-gray-700 text-base sm:text-lg">Late Mrs. Manjula Shukla</p>
                    </div>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="wedding-divider mb-6"></div>
                  <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed">
                    [Placeholder: This section can be used for additional information such as education, career, hobbies, interests, or any other details you'd like to share about Jay.]
                  </p>
                </motion.section>
              </div>
